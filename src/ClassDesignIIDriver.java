...
public class ClassDesignIIDriver {
    ...
    public static void mutate(int z) {
        ...
        z = -1000;
        //if z is only a copy, this won't affect the variable a's value in main
        //this.foo = -1000;
    ...
    public static void mutate(Dimension c) {
        c.height = -1000;
        c.width = -1000;
        //if I didn't hand this function a copy of b from main, but rather a
        // reference to the object that is known in main as b, what happens here?
